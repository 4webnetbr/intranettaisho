...
function calcula_pagamento() {
    ...
    if (empresa == null) {
        ...
        url = "/RhPagamento/busca_dados?empresa=" + empresa + "&competencia=" + competencia + "&vtcur=" + vtcuritiba + "&vtmet=" + vtmetropolitana;
...
function calcula_gorgeta() {
    ...
    if (empresa == null) {
        ...
        url = "/RhGorjeta/busca_dados?empresa=" + empresa + "&competencia=" + competencia + "&valordistribuido=" + valordistribuido;
        montaListaDados(tabela, url);
    }
}
...
function carrega_solver(obj) {
    ...
    if (empresa == null) {
        ...
        if (idobj == 'set_id') {
            boxAlert('Informe o Valor Distribuído', true, '', false, 1, false, 'Valor Distribuído');
        }
    } else if (setor == null) {
        if (idobj == 'set_id') {
        ...
        url = "/RhSolver/busca_dados?empresa=" + empresa + "&competencia=" + competencia + "&setor=" + setor + "&distribui=" + distrib;
