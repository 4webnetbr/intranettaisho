(function(factory) {
  ...
  var pluginName = 'bootstrapDualListbox',
    defaults = {
      ...
      moveSelectedLabel: 'Mover seleção',
      moveAllLabel: 'Mover todos',
      removeSelectedLabel: 'Remover seleção',
      removeAllLabel: 'Remover todos',
      moveOnSelect: true,                                                                 // true/false (forced true on androids, see the comment later)
      moveOnDoubleClick: true,                                                            // true/false (forced false on androids, cause moveOnSelect is forced to true)
      preserveSelectionOnMove: true,                                                     // 'all' / 'moved' / false
      selectedListLabel: 'Selecionados',                                                           // 'string', false
      nonSelectedListLabel: 'Disponíveis',                                                        // 'string', false
      helperSelectNamePostfix: '_helper',                                                 // 'string_of_postfix' / false
      selectorMinimalHeight: 100,
      showFilterInputs: true,                                                             // whether to show filter inputs
      nonSelectedFilter: '',                                                              // string, filter the non selected options
      selectedFilter: '',                                                                 // string, filter the selected options
      infoText: 'Todos {0}',                                                        // text when all options are visible / false for no info text
      ...
      infoTextEmpty: 'Nenhum',                                                        // when there are no options present in the list
      ...
      btnClass: 'btn-outline-primary',                                                  // sets the button style class for all the buttons
  ...
  BootstrapDualListbox.prototype = {
    ...
    setSelectOrMinimalHeight: function(value, refresh) {
      ...
      var height = this.element.attr('data-size');
      if (height < value) {
        height = value;
      }
