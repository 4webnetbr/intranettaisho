...
class Pdf extends FPDF
{
    ...
    **/
    function header()
    {
		...
		$this->Cell(0,3,utf8_decode('Artefatos de Metais Pelegrini Ltda'),0,1,'R');
		$this->SetFont('Arial','',7);
		$this->Cell(0,3,utf8_decode('CNPJ: 00.526.010/0001-65'),0,1,'R');
		$this->Cell(0,3,utf8_decode('I.E: 100.07351-04'),0,1,'R');
		$this->Cell(0,3,utf8_decode('R. Professor Alfredo Valente, 1158 - Jd Gramados - Alm. Tamandaré - CEP 83.504-000'),0,1,'R');
		$this->Cell(0,3,utf8_decode('Telefone: (41) 3657-7755'),0,1,'R');
    ...
    **/
    function footer()
    {
        ...
        $this->Cell(0,0,"{$this->footer_page_literal} ".$this->PageNo().'/{nb}',0,0,'R');
    }
