...
class RechumQuadroModel extends Model
{
    protected $DBGroup          = 'dbRh';

    protected $table            = 'rh_quadro';
    protected $view             = 'vw_rh_quadro_lista_relac';
    ...
    protected $allowedFields    = [ 'qua_id',
                                    'emp_id',
                                    'set_id',
                                    // 'tur_id',
                                ];
...
/**
     ...
     * @return array
     */
    public function getQuadro($qua_id = false, $emp_id = false, $set_id = false)
    {
        $db = db_connect('dbRh');
